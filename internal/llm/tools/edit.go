...
func NewEditTool(lspClients map[string]*lsp.Client, permissions permissionService, history *HistoryService) BaseTool {
	return &editTool{
...
func (e *editTool) createNewFile(ctx context.Context, filePath, content string) (ToolResponse, error) {
	...
	if !p {
		return ToolResponse{}, ErrorPermissionDenied
	}
	...
	// Store the content after creation
	e.history.SaveFileVersion(filePath, content)
...
func (e *editTool) deleteContent(ctx context.Context, filePath, oldString string) (ToolResponse, error) {
	...
	// Save empty version for deletion
	e.history.SaveFileVersion(filePath, "")
...
func (e *editTool) replaceContent(ctx context.Context, filePath, oldString, newString string) (ToolResponse, error) {
	...
	// Save new version
	e.history.SaveFileVersion(filePath, newContent)

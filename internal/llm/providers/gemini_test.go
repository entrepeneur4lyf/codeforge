...
func TestGeminiHandler_ModelRegistry_Integration(t *testing.T) {
	...
	model, exists := registry.GetModel(models.ModelGemini25FlashCanonical)
	if !exists {
	...
	providerModelID, err := registry.GetProviderModelID(models.ModelGemini25FlashCanonical, models.ProviderGeminiCanonical)
	if err != nil {
	...
	vertexModelID, err := registry.GetProviderModelID(models.ModelGemini25FlashCanonical, models.ProviderVertexCanonical)
	if err != nil {
